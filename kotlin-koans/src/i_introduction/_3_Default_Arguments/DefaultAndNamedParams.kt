...
fun foo(name: String, theNumber: Int = 42, toUpperCase: Boolean = false): String {
    return (if (toUpperCase) name.toUpperCase() else name) + theNumber
}
...
fun task3(): String {
    return (foo("a") +
            ...
            foo(name = "d", theNumber = 2, toUpperCase = true))
}
