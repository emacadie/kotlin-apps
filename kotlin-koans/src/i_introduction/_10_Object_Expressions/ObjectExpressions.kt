...
fun task10(): List<Int> {
    ...
    return arrayList
    // I got this from Stack Overflow since I did not understand the docs too well
    // they used AWT classes, and I am not too familiar with that
    // not too familiar with anonymous inner stuff in general
    // so the method argument itself contains the overriding function
    // just like in the docs, the method arg itself was the definition
